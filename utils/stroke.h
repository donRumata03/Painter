...
struct stroke
{
	...
	point coords_at(double t) const; // Count the point of Bezier curve corresponding to t value given as the argument
	double height_at(double t) const; // The height of the curve at x corresponding to time point t
};
