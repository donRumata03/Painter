...
//	);
	...
	configured_generator = final_population_generator(limits, stroking_params.stroke_number);
	configured_crossover = final_crossover();
	configured_mutator = mutator(limits, stroking_params.move_mutation_probability);
