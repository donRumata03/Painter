...
void rasterize_stroke(Image& target_image, const colored_stroke& stroke, size_t point_number = 100, StrokeRasterizationAlgorithm algo = StrokeRasterizationAlgorithm::smooth);
