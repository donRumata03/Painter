...
/// Resultant images are in RGB, type is double 3 channels, from [0., 1.]
...
void save_image(const Image &img, const fs::path &filename);  // Assume image is in RGB, elements are of type double
